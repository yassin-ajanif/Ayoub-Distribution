...
public partial class BonSortiePaiementRowViewModel : ObservableObject
{
    private readonly BonSortieEditViewModel _owner;
    ...
    public bool BonSortieModifiable => _owner.CanEditDraft;
    ...
    public BonSortiePaiementRowViewModel(BonSortieEditViewModel owner, PaiementBonSortie p)
    {
        _owner = owner;
        Id = p.Id;
        Montant = p.Montant;
    ...
    private bool CanStartEdit() => BonSortieModifiable && !IsEditing;
