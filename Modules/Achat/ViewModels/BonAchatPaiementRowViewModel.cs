...
public partial class BonAchatPaiementRowViewModel : ObservableObject
{
    private readonly BonAchatEditViewModel _owner;
    ...
    public bool BonAchatModifiable => _owner.CanEditDraft;
    ...
    public BonAchatPaiementRowViewModel(BonAchatEditViewModel owner, PaiementBonAchat p)
    {
        _owner = owner;
        Id = p.Id;
        Montant = p.Montant;
    ...
    private bool CanStartEdit() => BonAchatModifiable && !IsEditing;
