...
public sealed class StockMovementService : IStockMovementService
{
    ...
    public const string OrigineTypeBonSortie = "BS";
    ...
    public Task ResyncBonSortieStockAsync(
        AppDbContext db,
        int bonSortieId,
        string noteDetail,
    ...
    public Task ResyncBonAchatStockAsync(
        AppDbContext db,
        int bonAchatId,
        string noteDetail,
        IEnumerable<(int ProduitId, decimal Quantite)> lines,
    ...
    public Task SyncBonRetourStockAsync(
        AppDbContext db,
        int bonRetourId,
        string noteDetail,
