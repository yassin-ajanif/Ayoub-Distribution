...
public sealed class ReportService : IReportService
{
        ...
        DateTime from, DateTime to, CancellationToken ct = default)
    {
        ...
        var avoirsClient = await db.BonsRetour.AsNoTracking()
            .Where(a => a.Date >= from && a.Date < toEnd)
            .Select(a => new
            {
                a.Id,
        ...
        foreach (var a in avoirsClient)
        {
            ...
            totalBonsRetourClient += ttc;
            rows.Add(new ReportProfitChargeRow(
                ReportProfitChargeKind.BonRetourClient,
                typeBonRetourClient,
        ...
        return new ReportProfitChargesResult
        {
            ...
            TotalBonsRetourClient = totalBonsRetourClient,
